// https://github.com/malinajs/repl/blob/master/src/lib/highlight.js

import Prism from "https://cdn.skypack.dev/prismjs/components/prism-core.js";
import "https://cdn.skypack.dev/prismjs/components/prism-clike.js";
...
function langDefinitionMalina(Prism) {
  const expression = {
    ...
    inside: {
      ...
      "keyword":
        /([#:\/@](if|else|each|await|then|catch|html|slot|fragment))|\$element|\$event|\$onDestroy|\$onMount|\$props|\$attributes|\$emit/,
      "selector": /^:[A-Za-z0-9]+/,
